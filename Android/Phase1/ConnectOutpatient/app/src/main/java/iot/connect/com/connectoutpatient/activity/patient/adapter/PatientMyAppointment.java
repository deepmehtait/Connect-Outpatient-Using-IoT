package iot.connect.com.connectoutpatient.activity.patient.adapter;
 ...
 */
public class PatientMyAppointment extends BaseAdapter {
    ArrayList<ViewAppoinment> viewAppoinments=new ArrayList<ViewAppoinment>();
    Context context;
    private static LayoutInflater inflater=null;

    public PatientMyAppointment(Context context, ArrayList<ViewAppoinment> mpld){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.patientName.setText(viewAppoinments.get(position).getDoctorName());
        ...
        Picasso.with(row.getContext()).load(AppBaseURL.BaseURL+viewAppoinments.get(position).getDoctorProfileImageURL()).error(R.drawable.noimg).into(holder.patientImage);
