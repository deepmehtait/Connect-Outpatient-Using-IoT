...
public class ViewAppoinment {
    ...
    String zipcode,state,city,address,locationName,doctorName,doctorPhone,date,doctorId,patientId,patientName,time,patientProfileImageURL,doctorProfileImageURL;
